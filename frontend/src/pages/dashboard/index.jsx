...
export default function Dashboard() {
  ...
  const user = authState.user || {}; // ✅ Ensure user is always an object
  ...
  //  
  useEffect(() => {
    console.log("Posts in Redux:", postState.posts);
  }, [postState.posts]);
    ...
    return (
      <UserLayout>
        <DashboardLayout>
            ...
            <div className={styles.wrapper}>
              <div className={styles.createPostContainer}>
                <img className={styles.userProfile}
                  src={user?.profilePicture ? `${BASE_URL}/${user.profilePicture}` : "/defaultProfile.jpg"} alt="Profile"
                  onError={(e) => (e.target.src = "/defaultProfile.jpg")} />


                <textarea onChange={(e) => setPostContent(e.target.value)} value={postContent} placeholder={"what's in your mind?"} className={styles.textAreaOfContent} ></textarea>
                        ...
                        <div>
                          ...
                          <div className={styles.optionsContainer}>
                            ...
                            <div onClick={() => {
                              ...
                              const url = encodeURIComponent("LinkUp.in");
          ...
          {postState.postId !== "" &&
            <div onClick={() => { dispatch(resetPostId()) }}
